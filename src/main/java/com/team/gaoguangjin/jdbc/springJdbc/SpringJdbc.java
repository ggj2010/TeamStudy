...
public class SpringJdbc {
	public static void main(String[] args) {
		...
		//
		// testDriverManagerDataSource(beanFactory);
	}
	...
	public static void testDriverManagerDataSource(ApplicationContext ac) {
	  ...
	  * 如果是读取jdbc.properties里面的数据，根据<context:property-placeholder location="classpath:jdbc.properties" />
	  * 扫描到jdbc  
	  * 然后<property name="driverClassName" value="${jdbc.driverClassName}"/>
