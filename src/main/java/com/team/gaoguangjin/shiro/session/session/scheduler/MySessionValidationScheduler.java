package com.team.gaoguangjin.shiro.session.session.scheduler;
...
import com.team.gaoguangjin.shiro.session.JdbcTemplateUtils;
import com.team.gaoguangjin.shiro.session.SerializableUtils;
		...
		while (sessionList.size() > 0) {
			for (String sessionStr : sessionList) {
				try {
					...
					Method validateMethod = ReflectionUtils.findMethod(AbstractValidatingSessionManager.class, "validate", Session.class,
							SessionKey.class);
